...
![](https://fang-kang.gitee.io/blog-img/springMVC/img005.png#id=JtiUz&originHeight=854&originWidth=475&originalType=binary&ratio=1&status=done&style=none)
...
![](https://fang-kang.gitee.io/blog-img/springMVC/img006.png#id=ZePUZ&originHeight=79&originWidth=988&originalType=binary&ratio=1&status=done&style=none)

![](https://fang-kang.gitee.io/blog-img/springMVC/img007.png#id=Uc4Y0&originHeight=191&originWidth=594&originalType=binary&ratio=1&status=done&style=none)

iii. 如果有配置，则访问目标资源（一般为静态资源，如：JS,CSS,HTML），找不到客户端也会展示 404 错误

![](https://fang-kang.gitee.io/blog-img/springMVC/img008.png#id=wzxLq&originHeight=89&originWidth=1171&originalType=binary&ratio=1&status=done&style=none)

![](https://fang-kang.gitee.io/blog-img/springMVC/img009.png#id=FIrQb&originHeight=175&originWidth=670&originalType=binary&ratio=1&status=done&style=none)
